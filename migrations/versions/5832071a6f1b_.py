...
Revision ID: 5832071a6f1b
Revises: 
Create Date: 2021-02-01 17:09:03.494002
...
def upgrade():
    ...
    op.create_index(op.f('ix_businesses_yelp_id'), 'businesses', ['yelp_id'], unique=True)
...
def downgrade():
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_businesses_yelp_id'), table_name='businesses')
